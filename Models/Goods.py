...
class Goods(orm.Model):
    ...
    goods_name = orm.StringField(ddl='varchar(100)')
    goods_url = orm.StringField(ddl='varchar(100)')
    goods_picture_url = orm.StringField(ddl='varchar(100)')
    ...
    first_cid = orm.IntegerField(primary_key=False)
    second_cid = orm.IntegerField(primary_key=False)
    third_cid = orm.IntegerField(primary_key=False)
